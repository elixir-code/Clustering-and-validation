...
#define __PYX_HAVE___dbscan_inner
#define __PYX_HAVE_API___dbscan_inner
#include <vector>
#include "ios"
#include "new"
#include "stdexcept"
...
static const char __pyx_k_home_mukesh_Documents_Clusterin[] = "/home/mukesh/Documents/Clustering and Validation/Cython/_dbscan_inner.pyx";
...
static CYTHON_INLINE void __pyx_f_13_dbscan_inner_push(std::vector<npy_intp>  &__pyx_v_stack, npy_intp __pyx_v_i) {
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("push", 0);

  /* "_dbscan_inner.pyx":16
 * # a cdef function with an "except +" declaration.
 * cdef inline void push(vector[np.npy_intp] &stack, np.npy_intp i) except +:
 *     stack.push_back(i)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  goto __pyx_L0;
  __pyx_L1_error:;
  __Pyx_AddTraceback("_dbscan_inner.push", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_L0:;
...
/* Python wrapper */
static PyObject *__pyx_pw_13_dbscan_inner_1dbscan_inner(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
...
static PyObject *__pyx_pw_13_dbscan_inner_1dbscan_inner(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_neighborhoods)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("dbscan_inner", 1, 3, 3, 1); __PYX_ERR(0, 23, __pyx_L3_error)
        }
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_labels)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("dbscan_inner", 1, 3, 3, 2); __PYX_ERR(0, 23, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "dbscan_inner") < 0)) __PYX_ERR(0, 23, __pyx_L3_error)
      }
  ...
  __Pyx_RaiseArgtupleInvalid("dbscan_inner", 1, 3, 3, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 23, __pyx_L3_error)
  __pyx_L3_error:;
...
static PyObject *__pyx_pf_13_dbscan_inner_dbscan_inner(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_is_core, PyObject *__pyx_v_neighborhoods, PyArrayObject *__pyx_v_labels) {
  ...
  __pyx_pybuffernd_labels.rcbuffer = &__pyx_pybuffer_labels;
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_is_core.rcbuffer->pybuffer, (PyObject*)__pyx_v_is_core, &__Pyx_TypeInfo_nn___pyx_t_5numpy_uint8_t, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 23, __pyx_L1_error)
  }
...
#endif
{
  ...
  #endif
  if (__pyx_module_is_main__dbscan_inner) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "_dbscan_inner")) {
      if (unlikely(PyDict_SetItemString(modules, "_dbscan_inner", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_dbscan_inner, __pyx_t_1) < 0) __PYX_ERR(0, 23, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init _dbscan_inner", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init _dbscan_inner");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
