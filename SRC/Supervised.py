...
class Classification:
    ...
    def train_test_split(self):
	    self.data_train, self.data_test, self.labels_train, self.labels_test = train_test_split(self.data,self.class_labels, test_size=0.20, random_state=42)
    ...
    def perform_DecisionTreeClassifier(self):
        ...
        self.DecisionTreeClassifier_result=DT_clf.predict(self.data_test)
    ...
    def perform_QuadraticDiscriminantAnalysis(self):
        ...
        self.QuadraticDiscriminantAnalysis_result =  QDA_clf.predict(self.data_test)
    ...
    def perform_svm_SVC(self):
        ...
        self.SVC_result= SVC_classifier.predict(self.data_test)
    ...
    def perform_KNeighborsClassifier(self):
        ...
        self.KNeighborsClassifier_result=KNeighbors_classifier.predict(self.data_test)
        
        #print_dict(self.KNeighborsClassifier_result)
        
    def perform_random_forest_classifier(self):
        rf_classifier = RandomForestClassifier(n_estimators=10,max_features=sqrt(self.n_features))
        rf_classifier = rf_classifier.fit(self.data_train,self.labels_train)
        self.rfc_result =  rf_classifier.predict(self.data_test)
        
        #print_dict(self.rfc_result)
def label_cnt_dict(self,labels):
